...
denis = Admin('denis', 'rrapaj', 'moodfew', 'rrapajdenis2006@gmail.com', 'Albania', '069999999')
denis.describe_user()

denis_privileges = ['can make modifications to the server.',
                    'can reset passwords.',
                    'can remove users.']

denis.privileges.privileges = denis_privileges
denis.privileges.show_privileges()
